...
See [Kuzzle user authentication documentation](https://docs.kuzzle.io/core/1/guides/essentials/user-authentication/) for more details about Kuzzle authentication mechanism.

# How to create a plugin

See [Kuzzle plugin documentation](https://docs.kuzzle.io/core/1/plugins/) about plugin for more information about how to create your own plugin.
