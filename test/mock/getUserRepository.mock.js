...
module.exports = plugin => {
  ...
  class Repository {
    constructor() {
      this.create = sinon.stub().returns(this.fromDTO({_id: 'foo', kuid: 'someId'}));
      ...
      this.search = sinon.stub().returns({total: 1, hits: [this.fromDTO({_id: 'foo2', kuid: 'someId'})]});
      this.update = sinon.stub().returns(this.fromDTO({_id: 'foo', kuid: 'someId'}));
    }
