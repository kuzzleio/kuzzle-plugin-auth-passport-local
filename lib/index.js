...
class AuthenticationPlugin {
  ...
  init (customConfig, context) {
    ...
    if (['sha256', 'sha512'].indexOf(this.config.algorithm) === -1) {
      return Promise.reject(new this.context.errors.BadRequestError(`plugin-auth-passport-local: The 'algorithm' attribute must be either "sha256" or "sha512"; provided "${this.config.algorithm}".`));
    }
