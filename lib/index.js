...
class AuthenticationPlugin {
  ...
  init (customConfig, context) {
    ...
    if (this.passwordManager.availableAlgorithms[this.config.algorithm] < 200) {
      console.warn('[WARNING] plugin-auth-passwort-local: sha1 encryption algorithm has been broken and is now deprecated. Consider using sha512 instead. Please note that changing the encryption algorithm will only affect new password creations or updates.');
    }
